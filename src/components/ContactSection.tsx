        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="bg-onehealth-gray rounded-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-onehealth-blue hover:bg-onehealth-darkblue">
                Enviar Mensagem
              </Button>
            </form>
          </div>
          ...
          <div className="flex flex-col lg:pl-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">(12) 9810-08888</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">contato@onehealth.tec.br</p>
                  </div>
                </div>
            ...
            <div className="mt-auto">
              <div className="bg-gradient-onehealth text-white p-6 rounded-xl">
                ...
                <Button 
                  variant="outline" 
                  className="w-full bg-white text-onehealth-blue hover:bg-gray-100 border-none"
                  onClick={() => {
