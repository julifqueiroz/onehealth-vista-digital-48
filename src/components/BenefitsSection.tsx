  ...
  return <section id="benefits" className="py-20 bg-onehealth-gray">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map(benefit => <div key={benefit.id} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-24 h-24 bg-onehealth-blue opacity-5 rounded-bl-full z-10"></div>
            </div>)}
        </div>
